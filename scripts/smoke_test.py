...
class SmokeTestSuite:
    ...
    def test_prediction_endpoint(self):
        ...
        try:
            ...
            logger.info(f"✓ {test_name} passed (Prediction: {prediction}, Confidence: {confidence:.4f})")
            self.results.append((test_name, True, f"Pred: {prediction}"))
            return True
    ...
    def test_invalid_image(self):
        ...
        try:
            ...
            logger.info(f"✓ {test_name} passed (correctly rejected invalid image)")
            self.results.append((test_name, True, ""))
            return True
    ...
    def test_batch_predictions(self):
        ...
        try:
            ...
            logger.info(f"✓ {test_name} passed (5 batch predictions completed)")
            self.results.append((test_name, True, "5 predictions"))
            return True
